...
_s(AuthProvider, "qy4nfze8xCSGEzS5yR6wNe7BdLk=", false, function() {
    return [
...
function appReducer(state, action) {
    switch(action.type){
        ...
        case 'UPDATE_FIRM':
            return {
                ...state,
                firms: state.firms.map((firm)=>firm.id === action.payload.id ? action.payload : firm)
            };
        case 'DELETE_FIRM':
            return {
                ...state,
...
function AppProvider({ children }) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "AppProvider.useEffect": ()=>{
            ...
            const loadBillsFromBackend = {
                "AppProvider.useEffect.loadBillsFromBackend": async ()=>{
                    try {
                        ...
                        if (response.ok) {
                            ...
                            console.log('📋 Bills status breakdown:', bills.map({
                                "AppProvider.useEffect.loadBillsFromBackend": (b)=>({
                                        id: b.id,
                                        title: b.title,
                                        status: b.status
                                    })
                            }["AppProvider.useEffect.loadBillsFromBackend"]));
...
function canAccessBill(user, bill) {
    ...
    if (hasRole(user, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserRole"].ADMIN)) return true;
    ...
    switch(bill.status){
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].SUBMITTED:
            return hasRole(user, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserRole"].APPROVER);
        ...
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].DATA_ENTRY_PENDING:
            return hasRole(user, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserRole"].DATA_ENTRY);
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].DATA_ENTRY_COMPLETED:
            return hasRole(user, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserRole"].DATA_APPROVER);
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].DATA_APPROVED:
            return hasRole(user, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserRole"].VERIFIER);
        default:
            return false;
    }
}
function getNextStatus(currentStatus, action) {
    if (action === 'reject') {
        switch(currentStatus){
            case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].SUBMITTED:
                return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].REJECTED;
            case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].DATA_ENTRY_COMPLETED:
                return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].DATA_REJECTED;
            case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].DATA_APPROVED:
                return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].FINAL_REJECTED;
            default:
    ...
    switch(currentStatus){
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].SUBMITTED:
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].APPROVED;
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].APPROVED:
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].DATA_ENTRY_PENDING;
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].DATA_ENTRY_COMPLETED:
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].DATA_APPROVED;
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].DATA_APPROVED:
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].VERIFIED;
        case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].VERIFIED:
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BillStatus"].FINAL_APPROVED;
        default:
            return currentStatus;
    }
}
...
//# sourceMappingURL=_20b279ba._.js.map